...
const features = [
  {
    title: "Smart Search",
    description:
      "Find images quickly by title, category, and tags with a clean search-first experience.",
  },
  {
    title: "Curated Collections",
    description:
      "Organize images into themes so users can browse content in a structured and visual way.",
  },
  {
    title: "Fast UI",
    description:
      "Designed for a smooth gallery workflow with responsive layouts and simple navigation.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#f6f7fb] text-slate-900">
      <header className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-6 py-6 sm:px-10 lg:px-16">
        <div>
          <h2 className="text-[24px] font-bold tracking-[-0.02em] text-[#0f172f]">
            Image Search Gallery
          </h2>
          <p className="mt-1 text-sm text-[#64748b]">
            Discover curated image collections
          </p>
        </div>
          ...
          {currentUser ? (
            ...
            <>
              <Link to="/auth?mode=login">
                <button className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">
                  Login
                </button>
              </Link>
      ...
      <main>
        <section className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-14 px-6 pb-20 pt-8 sm:px-10 lg:grid-cols-[1fr_1.15fr] lg:items-center lg:px-16 lg:pb-24 lg:pt-10">
          <div>
            ...
            <p className="mt-6 max-w-[620px] text-[19px] leading-8 text-[#64748b] sm:text-[21px]">
              Showcase your platform before login with a polished landing page
              that highlights features, benefits, and a visual product preview.
              Perfect for demos, presentations, and hackathon submissions.
            </p>
                ...
                {previewImages.map((image) => (
                  ...
                  >
                    ...
                    <div className="bg-[#e7ebf3] p-4">
                      <p className="text-base font-semibold text-[#0f172f]">
                        {image.title}
                      </p>
                      <p className="mt-1 text-sm text-[#64748b]">
                        {image.subtitle}
        ...
        <section
          id="features"
          className="mx-auto w-full max-w-[1440px] px-6 py-10 sm:px-10 lg:px-16 lg:py-14"
        >
          <div className="max-w-[720px]">
            ...
            <p className="mt-4 text-[18px] leading-8 text-[#64748b]">
              Present your app like a real product with clear messaging,
              organized sections, and visual UI previews that communicate value
              quickly.
            </p>
          </div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="rounded-[30px] bg-white p-7 shadow-sm ring-1 ring-slate-200"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#dde7ff] text-lg font-bold text-[#28457a]">
                  {feature.title.charAt(0)}
                </div>
                <h3 className="mt-5 text-[24px] font-bold text-[#0f172f]">
                  {feature.title}
                </h3>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="rounded-[34px] bg-[#000d33] px-8 py-10 text-white sm:px-10 lg:px-12 lg:py-14">
              ...
              <p className="mt-5 max-w-[620px] text-[18px] leading-8 text-white/75">
                This layout helps your team present the image gallery as a
                complete platform, not just a simple project page. It improves
                first impression, product clarity, and demo confidence.
              </p>
            </div>
            ...
            <div className="grid gap-4">
              {benefits.map((benefit) => (
                <div
                  key={benefit}
                  className="rounded-[28px] bg-white px-6 py-5 shadow-sm ring-1 ring-slate-200"
                >
                  <div className="flex items-start gap-4">
                    <div className="mt-1 h-3 w-3 rounded-full bg-[#28457a]" />
                    <p className="text-[17px] font-medium text-[#334155]">
                      {benefit}
                    </p>
                  </div>
                </div>
          ...
          <div className="rounded-[36px] bg-white px-8 py-10 shadow-[0_20px_60px_rgba(15,23,47,0.08)] ring-1 ring-slate-200 sm:px-10 lg:flex lg:items-center lg:justify-between lg:px-14 lg:py-14">
            <div className="max-w-[720px]">
              ...
              <h2 className="mt-3 text-[34px] font-bold tracking-[-0.03em] text-[#0f172f] sm:text-[44px]">
                Ready to present your gallery platform with a stronger first
                impression?
              </h2>
              <p className="mt-4 text-[18px] leading-8 text-[#64748b]">
                Use this landing page as the introduction before login, then
                connect it to your authentication and gallery pages.
              </p>
            </div>

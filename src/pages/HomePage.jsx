...
const features = [
  {
    ...
    description: "Instantly find specific memories by searching for people, places, or objects within your photos.",
  },
  {
    icon: Layout,
    title: "Smart Albums",
    description: "Your photos are automatically organized into beautiful collections based on time and location.",
  },
  {
    icon: Zap,
    title: "Instant Upload",
    description: "Seamlessly sync your library from any device with high-speed background uploading.",
  },
];
        ...
        >
          <div className="flex w-full max-w-[1440px] items-center justify-between px-6 sm:px-10 lg:px-16">
            ...
            <div className="flex items-center gap-3">
              {currentUser ? (
                  <>
                    <Link to="/user-home" className="hidden sm:flex items-center gap-2 rounded-xl bg-slate-100 px-4 py-2.5 text-sm font-semibold text-[#0f172f] transition hover:bg-slate-200">
          ...
          <section className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-16 px-6 pb-20 sm:px-10 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:px-16 lg:pb-32">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mt-8 max-w-[700px] text-[48px] font-extrabold leading-[1.05] tracking-tight text-[#0f172f] sm:text-[64px] lg:text-[72px]">
                A more intelligent home for your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#000d33] to-[#3a63ad]">greatest moments.</span>
              </h1>

              <p className="mt-6 max-w-[600px] text-[18px] leading-relaxed text-[#64748b] sm:text-[20px]">
                Effortlessly upload, organize, and rediscover your favorite moments.
                Experience a secure, AI-powered gallery designed to keep your life's
                story safe and searchable.
              </p>

              <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                {currentUser ? (
                    <Link to="/user-home" className="group flex items-center justify-center gap-2 rounded-2xl bg-[#000d33] px-8 py-4 text-[16px] font-semibold text-white shadow-lg shadow-[#000d33]/25 transition-all hover:-translate-y-0.5 hover:bg-[#00154d] hover:shadow-xl hover:shadow-[#000d33]/30">
                ...
                <a href="#preview" className="flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-8 py-4 text-[16px] font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 hover:border-slate-300">
                  Try the Search
                </a>
              </div>
              ...
              <div className="mt-14 flex items-center gap-8 border-t border-slate-200 pt-8">
                <div>
                  <p className="text-[32px] font-extrabold tracking-tight text-[#0f172f]">10k+</p>
                  <p className="text-sm font-medium text-[#64748b]">Photos stored</p>
                </div>
                <div className="h-12 w-px bg-slate-200"></div>
                <div>
                  <p className="text-[32px] font-extrabold tracking-tight text-[#0f172f]">Unlimited</p>
                  <p className="text-sm font-medium text-[#64748b]">Cloud backup</p>
                </div>
                <div className="hidden sm:block h-12 w-px bg-slate-200"></div>
                <div className="hidden sm:block">
                  <p className="text-[32px] font-extrabold tracking-tight text-[#0f172f]">99.9%</p>
                  <p className="text-sm font-medium text-[#64748b]">Uptime safety</p>
                </div>
              </div>
            </div>

            {/* Interactive Preview Card */}
            <div id="preview" className="relative flex items-center justify-center lg:justify-end">
              ...
              <div className="relative w-full max-w-[680px] rounded-[32px] border border-white/40 bg-white/10 p-6 shadow-[0_24px_80px_rgba(15,23,47,0.15),inset_0_1px_2px_rgba(255,255,255,0.6)] backdrop-blur-3xl backdrop-saturate-200 sm:p-8">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  <span className="text-xs font-semibold text-slate-600 uppercase tracking-wider py-2 pr-2 drop-shadow-sm">Explore:</span>
                  {themeData.map((theme) => (
                      <button
                          key={theme.id}
                          type="button"
                ...
                {previewImages.length === 0 ? (
                    <div className="mt-6 flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/40 bg-white/10 backdrop-blur-md py-12 text-center shadow-sm">
                      <Search className="mb-3 text-slate-600 drop-shadow-sm" size={32} />
                      <p className="text-sm font-medium text-[#0f172f] drop-shadow-sm">No matches found</p>
                      <p className="mt-1 text-xs text-slate-600 drop-shadow-sm">Try searching for a different memory.</p>
                    </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
              <div className="max-w-[720px]">
                ...
                <p className="mt-5 text-[18px] leading-relaxed text-[#64748b]">
                  From high-speed uploads to intelligent categorization, we’ve built
                  the ultimate space to archive your life's journey.
                </p>
              </div>
                ...
                <div className="relative overflow-hidden rounded-[40px] bg-[#000d33] px-8 py-12 sm:px-12 lg:py-20 shadow-2xl">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="mt-6 text-[18px] leading-relaxed text-white/80">
                      PixelVault isn't just a folder; it's an intelligent assistant
                      that helps you find exactly what you're looking for, the
                      moment you need it. Secure, private, and yours.
                    </p>
                  </div>
                </div>
            ...
            <div className="relative overflow-hidden rounded-[40px] border border-white/60 bg-white/20 px-8 py-14 shadow-[0_24px_80px_rgba(15,23,47,0.06),inset_0_1px_2px_rgba(255,255,255,0.7)] backdrop-blur-3xl backdrop-saturate-150 sm:px-14 lg:py-20 text-center">
              ...
              <div className="relative z-10 mx-auto max-w-[800px]">
                ...
                <p className="mx-auto mt-6 max-w-[600px] text-[18px] leading-relaxed text-[#64748b]">
                  Join thousands of users who trust PixelVault to keep their photos safe,
                  searchable, and stunningly organized.
                </p>
              </div>

              <div className="relative z-10 mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                {currentUser ? (
                    <Link to="/user-home" className="flex items-center gap-2 rounded-2xl bg-[#000d33] px-10 py-4 text-[16px] font-bold text-white shadow-lg shadow-[#000d33]/20 transition-all hover:-translate-y-0.5 hover:bg-[#00154d]">
                      <LayoutDashboard size={20} />
                      Open My Vault
                    </Link>
                ) : (
          ...
          <div className="mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
            <div className="grid grid-cols-1 gap-10 md:grid-cols-4 lg:grid-cols-5">
              ...
              <div className="lg:col-span-2">
                ...
                <p className="mt-5 max-w-[300px] text-[15px] leading-relaxed text-[#64748b]">
                  The modern home for organizing, searching, and showcasing your life's memories with lightning speed and elegant design.
                </p>
              </div>

              {/* Links Columns */}
              <div>
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#0f172f]">Features</h3>
                <ul className="mt-5 flex flex-col gap-3">
                  {['Upload', 'AI Search', 'Sharing', 'Mobile App'].map((item) => (
                      <li key={item}>
                        <a href={`#${item.toLowerCase()}`} className="text-[15px] font-medium text-[#64748b] transition-colors hover:text-[#28457a]">
                          {item}
                        </a>
                      </li>
                  ))}
              ...
              <div>
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#0f172f]">Support</h3>
                <ul className="mt-5 flex flex-col gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold uppercase tracking-wider text-[#0f172f]">Legal</h3>
                <ul className="mt-5 flex flex-col gap-3">
                  {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item) => (
                      <li key={item}>
                        <a href={`#${item.toLowerCase().replace(/ /g, '-')}`} className="text-[15px] font-medium text-[#64748b] transition-colors hover:text-[#28457a]">
                          {item}
                        </a>
                      </li>
                  ))}
            ...
            <div className="mt-16 flex flex-col items-center justify-between border-t border-slate-100 pt-8 sm:flex-row gap-4">
              <p className="text-[14px] text-slate-500">
                © {new Date().getFullYear()} PixelVault Photos Inc. All rights reserved.
              </p>
              <div className="flex items-center gap-5 text-slate-400">
                <a href="#twitter" className="transition-colors hover:text-[#28457a]" aria-label="Twitter">
                  <Twitter size={20} strokeWidth={2.5} />
                </a>
                <a href="#github" className="transition-colors hover:text-[#28457a]" aria-label="GitHub">
                  <Github size={20} strokeWidth={2.5} />
                </a>
                <a href="#linkedin" className="transition-colors hover:text-[#28457a]" aria-label="LinkedIn">

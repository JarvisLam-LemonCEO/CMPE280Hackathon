...
const handleAlbumDragEnd = async (event) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex w-full max-w-360 items-center justify-between gap-3 px-4 sm:px-10 lg:px-16">
          <Link to="/" className="flex shrink-0 items-center gap-2 sm:gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#000d33] shadow-lg sm:h-10 sm:w-10">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2 sm:gap-3">
            <button
              ...
              className="flex h-10 items-center gap-2 rounded-xl bg-amber-500 px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-600 sm:px-4"
              aria-label="Create album"
            >
              <FolderPlus size={16} />
              <span className="hidden xl:inline">Create Album</span>
            </button>

            <button
              onClick={openCreateEventModal}
              className="flex h-10 items-center gap-2 rounded-xl bg-emerald-600 px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700 sm:px-4"
            ...
            <button
              ...
              className="flex h-10 items-center gap-2 rounded-xl bg-indigo-600 px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 sm:px-4"
              aria-label="Upload"
            >
              <Upload size={16} />
            ...
            <button
              ...
              className="flex h-10 items-center gap-2 rounded-xl bg-slate-100 px-3 text-sm font-semibold text-[#0f172f] transition hover:bg-slate-200 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700 sm:px-4"
              aria-label="Profile"
            >
              <User size={16} />
            ...
            <button
              ...
              className="group flex h-10 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-600 shadow-sm transition hover:border-red-100 hover:bg-red-50 hover:text-red-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-red-800 dark:hover:bg-red-900/20 dark:hover:text-red-400 sm:px-4"
              aria-label="Logout"
            >
              <LogOut
                size={16}
      ...
      {selectedIds.size > 0 && (
        <div className="pointer-events-none fixed inset-x-0 bottom-4 z-40 flex justify-center px-4 sm:bottom-6">
          <div className="pointer-events-auto flex flex-wrap items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/95 p-2 shadow-2xl backdrop-blur-md dark:border-slate-700 dark:bg-[#222b45]/95 sm:gap-3 sm:p-3">
            <span className="px-2 text-xs font-semibold text-slate-500 dark:text-slate-400 sm:text-sm">
              {selectedIds.size} selected
            </span>
            <button
              onClick={() => setShowAddToAlbumModal(true)}
              className="flex h-10 items-center gap-1.5 rounded-xl bg-[#28457a] px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-[#1d3456] sm:gap-2 sm:px-4 sm:text-sm"
            >
              <Plus size={16} />
            ...
            {selectedEditableUpload && isHFConfigured() && (
              <button
                ...
                className="flex h-10 items-center gap-1.5 rounded-xl bg-fuchsia-500 px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-fuchsia-600 sm:gap-2 sm:px-4 sm:text-sm"
              >
                <Sparkles size={16} />
            ...
            <button
              ...
              className="flex h-10 items-center gap-1.5 rounded-xl bg-red-500 px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-red-600 sm:gap-2 sm:px-4 sm:text-sm"
            >
              <Trash2 size={16} />
              <span>Delete</span>
            </button>
            ...
            <button
              ...
              className="flex h-10 items-center justify-center rounded-xl border border-slate-300 px-3 text-xs font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-800 sm:text-sm"
      ...
      <main
        className={`min-h-screen bg-[#f6f7fb] px-4 text-slate-900 dark:bg-[#1a2035] dark:text-white sm:px-10 lg:px-16 ${
          selectedIds.size > 0 ? "pb-32 sm:pb-28" : "pb-8"
        }`}
      >
        <div className="page-container pt-24 pb-0 sm:pt-28">
          <div className="section-card">
            ...
            {viewMode === "albums" && activeAlbum && (
              <div className="mt-6 flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200 bg-white/70 p-3 dark:border-slate-700 dark:bg-slate-900/20 sm:gap-3 sm:p-4">
                <input
                  type="text"
                  value={renameAlbumValue}
                  onChange={(e) => setRenameAlbumValue(e.target.value)}
                  placeholder="Album name"
                  className="h-11 w-full min-w-0 flex-1 rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-700 outline-none focus:border-indigo-300 focus:bg-white focus:ring-2 focus:ring-indigo-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 sm:w-auto sm:min-w-[240px]"
                />
            ...
            {viewMode === "events" && activeEvent && (
              <div className="mt-6 flex flex-wrap items-center gap-2 rounded-2xl border border-emerald-100 bg-emerald-50/70 p-3 dark:border-emerald-900/50 dark:bg-emerald-950/20 sm:gap-3 sm:p-4">
    ...
    <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
      {filteredImages.map((image) => (
        ...
        {showAIEditModal && selectedEditableUpload && (
          <div className="modal-overlay">
            <div className="max-h-[92vh] w-full max-w-[920px] overflow-y-auto rounded-[24px] bg-white p-0 shadow-2xl dark:bg-[#1f2740] sm:rounded-[32px]">
              <div className="grid gap-0 md:grid-cols-[1.1fr_0.9fr]">
                <div className="bg-slate-950 p-5 text-white sm:p-6 md:p-8">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-xs uppercase tracking-[0.24em] text-fuchsia-300">AI Edit</p>
                      <h2 className="mt-2 text-[20px] font-bold sm:text-[26px]">Transform selected photo</h2>
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-full border border-white/15 p-2 text-white/80 transition hover:bg-white/10 hover:text-white"
                      aria-label="Close"
                    >
                      <X size={18} />
                    </button>
                  ...
                  <div className="mt-5 overflow-hidden rounded-[20px] border border-white/10 bg-white/5 sm:mt-6 sm:rounded-[24px]">
                    <img
                ...
                <div className="p-5 sm:p-6 md:p-8">
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <button
                      ...
                      className="h-12 w-full rounded-2xl bg-fuchsia-500 text-sm font-semibold text-white shadow-md transition hover:bg-fuchsia-600 disabled:opacity-60"
                    >
        ...
        {showEditEventModal && activeEvent && (
          <div className="modal-overlay">
            <div className="max-h-[92vh] w-full max-w-[560px] overflow-y-auto rounded-[24px] bg-white p-5 shadow-xl dark:bg-[#2a3655] sm:rounded-[28px] sm:p-8">
              <h2 className="text-[24px] font-bold text-[#0f172f] dark:text-white">
                Edit Event
              </h2>
              <p className="modal-subtitle">
        ...
        {showCreateAlbumModal && (
          <div className="modal-overlay">
            <div className="max-h-[92vh] w-full max-w-[520px] overflow-y-auto rounded-[24px] bg-white p-5 shadow-xl dark:bg-[#2a3655] sm:rounded-[28px] sm:p-8">
              <h2 className="text-[24px] font-bold text-[#0f172f] dark:text-white">
                Create Album
              </h2>
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
        ...
        {showEventUploadModal && activeEvent && (
          <div className="modal-overlay">
            <div className="max-h-[92vh] w-full max-w-[540px] overflow-y-auto rounded-[24px] bg-white p-5 shadow-xl dark:bg-[#2a3655] sm:rounded-[28px] sm:p-8">
              <h2 className="text-[24px] font-bold text-[#0f172f] dark:text-white">
                Add Event Photo
              </h2>
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
